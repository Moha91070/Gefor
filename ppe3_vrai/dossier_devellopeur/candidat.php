...
<body>
        ...
        <thead>
            ...
            <OPTION VALUE="candidat.php?idformation=idformation">Tous</OPTION>
            <OPTION VALUE="candidat.php?idformation1=idformation">BTS Assurance</OPTION>
            <OPTION VALUE="candidat.php?idformation2=idformation">BTS Banque</OPTION>
            <OPTION VALUE="candidat.php?idformation3=idformation">BTS Comptabilité et Gestion</OPTION>
            <OPTION VALUE="candidat.php?idformation4=idformation">BTS Gestion de la PME</OPTION>
            <OPTION VALUE="candidat.php?idformation5=idformation">BTS Management des Unités Commerciales</OPTION>
            <OPTION VALUE="candidat.php?idformation6=idformation">BTS SIO option SLAM</OPTION>
            <OPTION VALUE="candidat.php?idformation7=idformation">BTS SIO option SISR</OPTION>
            </SELECT>
            </FORM>
        ...
        ?>
                <tr>
                    ...
                    <td> <div class="btn-group">
                            <a href="detail_candidat.php?idcandidat=<?= $perso['idcandidat'] ?>"><button type="button" class="btn btn-info" value="enable"> 
Info</button></a>
                            <a href="update_candidat.php?idcandidat=<?= $perso['idcandidat'] ?>"><button type="button" class="btn btn-warning">Modifier </
button></a>
                        </div> </td>
                </tr>
        <?php
    ...
    <nav>
                    <ul class="pagination">
                        ...
                        <li class="page-item <?= ($currentPage == 1) ? "disabled" : "" ?>">
                            <a href="candidat.php?page=<?= $currentPage - 1 ?>" class="page-link">Précédent</a>
                        </li>
                        <?php for($page = 1; $page <= $doc; $page++): ?>
                          <!-- Lien vers chacune des pages (activé si on se trouve sur la page correspondante) -->
                          <li class="page-item <?= ($currentPage == $doc) ? "active" : "" ?>">
                                <a href="candidat.php?idformation=<?= $doc ?>" class="page-link"><?= $page ?></a>
                            </li>
                        <?php endfor ?>
                          <!-- Lien vers la page suivante (désactivé si on se trouve sur la dernière page) -->
                          <li class="page-item <?= ($currentPage == $pages) ? "disabled" : "" ?>">
                            <a href="candidat.php?<?=$doc?>=idformation" class="page-link">Suivant</a>
                        </li>
                    </ul>
                </nav>
</body>
